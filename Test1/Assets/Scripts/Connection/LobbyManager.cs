...
public class LobbyManager : MonoBehaviourPunCallbacks
{
    ...
    private void Awake()
    {
        ...
        else
        {
            ...
            if (UserInfoManager.instance.isFirstConnect) //ÀÌ¶§ Áö±İÀÌ Ã¹ ·Î±×ÀÎÀ¸·Î µé¾î¿Â °æ¿ì¶ó¸é
            {
                UserInfoManager.instance.isFirstConnect = false; //·Îºñ ÀçÁ¢¼ÓÀÌ ÀÌÈÄºÎÅÏ ¼öÇàµÇµµ·Ï
            }
            else
            {
                Debug.Log("·Îºñ Á¢¼Ó");
    ...
    public void StartGameAlone() //È¥ÀÚÇÏ±â-½ÃÀÛÇÏ±â ¹öÆ° Å¬¸¯ ½Ã ¹Ù·Î ÇÃ·¹ÀÌ·ë ÀÌµ¿
    {
    ...
    {
        if (!string.IsNullOrEmpty(selectedRoomName)) //¹æÀÌ¸§ÀÌ ¹¹¶óµµ ÀÖÀ¸¸é
        {
