...
public class UserSetManager : MonoBehaviourPunCallbacks
{
    ...
    // ·Î±×ÀÎ ¿Ï·á È®ÀÎ ¹öÆ°/È¸¿ø°¡ÀÔ ¿Ï·á È®ÀÎ ¹öÆ° ´©¸£¸é -> playfab¿¡¼­ À¯Àú °íÀ¯ID ºÒ·¯¿Í photon¿¡ ÀúÀå
    //public void GetUserPlayfabID()
    //{
    //    // PlayFab¿¡ ·Î±×ÀÎµÈ »óÅÂ¿¡¼­ ID¸¸ ¿äÃ»
    //    PlayFabClientAPI.GetAccountInfo(new GetAccountInfoRequest(),
    //        static result =>
    //        {
    //            // À¯Àú Á¤º¸ ¹Ş¾Æ¿À±â ¼º°ø
    //            string playFabId = result.AccountInfo.PlayFabId;

    //            // PhotonÀÇ Custom Properties¿¡ PlayFabId ÀúÀå
    //            Hashtable playerProperties = new Hashtable();
    //            playerProperties.Add("PlayFabId", playFabId);

    //            PhotonNetwork.LocalPlayer.SetCustomProperties(playerProperties);  // ÇöÀç ÇÃ·¹ÀÌ¾î¿¡ ´ëÇÑ Á¤º¸ ÀúÀå

    //        },
    //    error =>
    //    {
    //        // À¯Àú Á¤º¸ ¹Ş¾Æ¿À±â ½ÇÆĞ
    //        Debug.LogError($"PlayFab ID °¡Á®¿À±â ½ÇÆĞ: {error.GenerateErrorReport()}");
    //    });
    //}
