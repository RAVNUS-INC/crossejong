...
{
    [SerializeField] public TMP_InputField inputText; //´Ğ³×ÀÓ ÀÔ·Â(³ªÁß¿¡ ¹Ù²Ü ¼ö ÀÖ´Â Displayname)
    [SerializeField] public Button confirmButton; //Á¦Ãâ(ÀúÀå) ¹öÆ°
    [SerializeField] TMP_Text warningText; // °æ°í ¸Ş½ÃÁö¸¦ Ãâ·ÂÇÒ UI ÅØ½ºÆ®
